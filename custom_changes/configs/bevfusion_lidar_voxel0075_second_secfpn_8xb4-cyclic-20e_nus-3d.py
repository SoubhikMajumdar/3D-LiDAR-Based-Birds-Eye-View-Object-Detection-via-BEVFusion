...
param_scheduler = [
    ...
    # During the first 4 epochs, learning rate increases from 0 to lr * 10
    # during the next 8 epochs, learning rate decreases from lr * 10 to
    # lr * 1e-4
    dict(
    ...
    dict(
        ...
        convert_to_iter_based=True),
    # momentum scheduler
    # During the first 4 epochs, momentum increases from 0 to 0.85 / 0.95
    # during the next 8 epochs, momentum increases from 0.85 / 0.95 to 1
    dict(
